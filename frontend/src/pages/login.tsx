      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <CardBox className="bg-white shadow-xl rounded-lg p-8">
          <div className="mb-4 text-sm text-gray-600">
            <p className="mb-2">
              Use{' '}
              <code className="cursor-pointer text-indigo-600" onClick={() => setLogin('super_admin@example.com')}>
            ...
            <p className="mb-2">
              Use{' '}
              <code className="cursor-pointer text-indigo-600" onClick={() => setLogin('admin@example.com')}>
                admin@example.com
              </code>{' '}
              to login as Admin
            </p>
            <p>
              Use{' '}
              <code className="cursor-pointer text-indigo-600" onClick={() => setLogin('client@example.com')}>
                client@example.com
              </code>{' '}
              to login as User
            </p>
