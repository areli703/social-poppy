module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('preferences', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('companies', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('preferences', 'userId', {
        transaction,
      });

      await queryInterface.removeColumn('preferences', 'topics', {
        transaction,
      });

      await queryInterface.removeColumn('preferences', 'style', {
        transaction,
      });

      await queryInterface.removeColumn('preferences', 'tone', { transaction });

      await queryInterface.removeColumn('preferences', 'goal', { transaction });

      await queryInterface.removeColumn('posts', 'userId', { transaction });

      await queryInterface.removeColumn('posts', 'generated_at', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('payments', 'paid_at', { transaction });
      ...
      await queryInterface.dropTable('preferences', { transaction });
