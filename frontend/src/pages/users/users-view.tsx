    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Preferences User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.preferences_user &&
                      Array.isArray(users.preferences_user) &&
                      users.preferences_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
